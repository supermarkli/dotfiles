...
info "4. terminal default profile，将 Linux 默认配置设为 zsh；或在 settings.json 设置 terminal.integrated.defaultProfile.linux=zsh"
...
info "8. 一些好用的插件：one dark pro；vscode-icons；Office Viewer"
